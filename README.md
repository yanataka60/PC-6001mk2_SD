...
　なお、市販ソフトでは2段目以降のCMTロードはBASIC-ROMを使わずに独自のロードルーチンを使っているものがあり、動かないことが多いです。また、MONITORのRコマンドも未対応です。
...
　出来上がったバイナリを27256等に焼いて本体内ICソケットに差し替えても良いのですが、CMTが使えなくなってしまいますので出来れば27512等にオリジナルバイナリを前半、パッチ済みバイナリを後半に置いて焼き、27512のA15をスイッチで5VとGNDに切り替えられるようにすると使い分けられるようになります。
